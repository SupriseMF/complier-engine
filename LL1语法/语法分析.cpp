...
int P8[]={TypeDecList,TypeId,getlex(":="),TypeDef,getlex(";"),TypeDecMore,-1};
...
int P41[]={ProcDec,	PROCEDURE,ProcName,getlex("("),ParamList,getlex(")"),getlex(";"),ProcDecPart,ProcBody,ProcDecMore,-1};
...
int PreSet58[]={ID,IF,WHILE,RETURN,READ,WRITE,END,getlex(";"),-1};
